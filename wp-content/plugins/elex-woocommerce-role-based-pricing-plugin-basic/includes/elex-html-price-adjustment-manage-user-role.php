	 ...
	 <div id="poststuff">
		<div class="postbox">
				 ...
				 <tr>
					<th style="padding: 15px;">
					   <label for="eh_woocommerce_pricing_discount_user_role_name"><b><?php
						  _e('User Role', 'elex-catmode-rolebased-price'); ?></b></label>
					</th>
					<td>
					   <input type="text" name="eh_woocommerce_pricing_discount_user_role_name" class="regular-text" value= ><br />
					   <span class="description"><?php
						  _e('Enter the name of the user role you want to create and click the Save Changes button.', 'elex-catmode-rolebased-price');
						  ?></span>
					</td>
				 </tr>
			  </table>
		   ...
		   <h3 class="hndle_delete_user_role" style="cursor:pointer;padding-left: 15px;color: #5b9dd9;"><?php
			  _e('Remove User Role', 'elex-catmode-rolebased-price'); ?></h3>
		   <div class="delete_user_role" style="border-top: solid 1.5px black;">
			  <table class="form-table">
				...
				<tr>
					...
					<td>
					<label><input type="checkbox" name="pricing_discount_remove_user_role[<?php _e( $id, 'elex-catmode-rolebased-price');?>]" ><?php echo $name; ?></label>
					</td>
				</tr>
				<?php } ?>
				<br/><span class="description" style="padding: 15px;"><?php
					_e('Select the user role you want to delete and click the Save Changes button.', 'elex-catmode-rolebased-price');
				?></span>
			</table>
		   </div>
		</div>
