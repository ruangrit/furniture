...
function mobilia_blog_sharing() {
	...
	<div class="widget widget_socialsharing_widget">
		<h3 class="widget-title"><?php if(isset($mobilia_opt['blog_share_title'])) { echo esc_html($mobilia_opt['blog_share_title']); } else { esc_html_e('Share this post', 'mobilia'); } ?></h3>
