<?php
function mobilia_product_sharing() {
	...
	<div class="widget widget_socialsharing_widget">
		<h3 class="widget-title"><?php if(isset($mobilia_opt['product_share_title'])) { echo esc_html($mobilia_opt['product_share_title']); } else { esc_html_e('Share this product', 'mobilia'); } ?></h3>
